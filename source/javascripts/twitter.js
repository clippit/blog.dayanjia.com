...
function getTwitterFeed(user, count, replies) {
  ...
  $.ajax({
    url: "http://dayanjia.com/blogtfeed.php?user=" + user + "&count=" + (count + 20) + "&exclude_replies=" + (replies ? "0" : "1") + "&callback=?",
    ...
    type: 'jsonp',
    error: function (err) { $('#tweets li.loading').addClass('error').text("更新失败"); },
